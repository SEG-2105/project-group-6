 ...
 * Parent class of Client, Landlord, and Property Manager
 */
public class User {
    ...
    /**
     * Constructor for creating an instance of Property Manager (which only requires certain attributes)
     *
     * @param userId    user id of property manager
    ...
    protected User(String userId, String firstName, String lastName, String email, UserRoles role) {
        if (role != UserRoles.PROPERTY_MANAGER) {
            throw new IllegalArgumentException("Invalid role. This constructor only supports users of type Property Manager");
        }
