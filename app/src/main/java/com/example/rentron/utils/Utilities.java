...
import com.example.rentron.utils.TrieSearch.StopWords;
...
public class Utilities {
    ...
    static public String getMapPropertyNames(Map<String, ?> mapObj) {
    ...
    static public List<String> getKeywords(List<String> data) {
        ...
        // if invalid value, or can't find any keywords, we return an empty list
    ...
    static private boolean isKeyword(String word) {
        // return true if the word is not a stop word, else return false
