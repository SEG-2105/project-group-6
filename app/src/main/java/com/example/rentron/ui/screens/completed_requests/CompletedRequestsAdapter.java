...
public class CompletedRequestsAdapter extends ArrayAdapter<Request> {
     ...
     */
    public CompletedRequestsAdapter(@NonNull Context context, int resource, @NonNull List<Request> objects) {
